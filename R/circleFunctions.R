...
circle.graphmapper<- function(npoints=100) {
  gm= makegraphmapper(circle_data(1, npoints), lensefun=lense.projection, lenseparam="X", partition_count=4, overlap = 0.5,bin_count=10)
  return(gm)
}
